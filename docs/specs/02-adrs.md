...
- Add an ADR for architecture, security, storage, runtime, or cross-component decisions.
- Keep rejected options and tradeoffs visible.
- Do not overwrite history. Supersede with a new ADR.
