...
- M11 dashboard data entry and review UIs: spec accepted, implementation pending. Replaces the M5 Transactions/Imports/Reports/Backups placeholder shells with real UIs and adds data-entry forms for the M9 write APIs.
