 ...
 */
export const createHousehold = <ThrowOnError extends boolean = false>(options?: Options<CreateHouseholdData, ThrowOnError>): RequestResult<CreateHouseholdResponses, CreateHouseholdErrors, ThrowOnError> => (options?.client ?? client).post<CreateHouseholdResponses, CreateHouseholdErrors, ThrowOnError>({ url: '/households', ...options });
